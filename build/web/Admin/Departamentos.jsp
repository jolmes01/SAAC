<%-- 
    ...
    Created on : 12/11/2015, 09:08:49 PM
    Author     : JL
--%>
...
<html>
    <head>
		...
		<!-- eazy-modal -->
		<script type="text/javascript" src="../plugins/eazy-modal/ezmodal.min.js"></script>
		<link rel="stylesheet" href="../plugins/eazy-modal/ezmodal.min.css"/>
    </head>
                    ...
                    <div class="row">
                        <section class="col-lg-10 connectedSortable">
                            ...
                            <% if (request.getParameter("param").equals("Alta") || request.getParameter("param").equals("Actualizar")) { %>
                                <%@include file="../Admin/forms/formularioDepto.jsp" %>
                            <% } else { %>
                               <%@include file="../Admin/forms/consultaDeptos.jsp" %>
                            <% }%>
                        </section><!-- /.Left col -->
                    </div><!-- /.row (main row) -->
