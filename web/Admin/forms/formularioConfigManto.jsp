...
<div class="box box-info">
    <div class="box-header">
        <h3 class="box-title">Configuración mantenimiento</h3>
        <!-- tools box -->
        <div class="pull-right box-tools">
            <button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
        </div><!-- /. tools -->
        <div class="box-body">
            <form class="form-horizontal" id="formConfig" action="../AddConfig?param=Mantenimiento">
                <div class="form-group">
                    <label for="inputCuota" class="col-sm-2 control-label">Porcentaje de la cuota por retraso</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputCuota" name="inputCuota" placeholder="12">
                    </div>
                </div>
                <div class="form-group">
